...
void setQuietState()
{
  ...
  topFullWindow.setDazzleEfx( dazzleTime, 50, 600);
  topLeftWindow.setNoEfx();
  topRightWindow.setNoEfx();

  leftWindow.setDazzleEfx( dazzleTime, 50, 600);
  rightWindow.setDazzleEfx( dazzleTime, 50, 600);
...
//  leftWindow.setBlinkEfx(RED, 100, 0);
  ...
  // player buttons solid color
  player1Ring.setDazzleEfx( dazzleTime, dazzelPercent, 50);//setBlinkEfx(RED, 100, 0); 
...
//  rightWindow.setBlinkEfx(GREEN, 100, 0);
  ...
  player2Ring.setDazzleEfx( dazzleTime, dazzelPercent, 50);
